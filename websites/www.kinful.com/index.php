<?php
$domains = array(
    'kinful.com', 'teacup.com.cn', 'kinful.cn', 'scanonly.com', '3dwindy.com', 'edulong.cn', 'edulong.net', 'ekotlin.com', 'ukotlin.com'
);
...
<script type="text/javascript" src="./home_files/ubox.js" charset="utf-8"></script></head><body><div style="display: none; z-index: 2147483640; top: 0px; left: 0px; position: fixed; height: 100%; width: 100%;"></div><div id="idBox" class="lightbox" style="display: none; z-index: 2147483647;">	<div id="boxMain">		<div id="boxTopTitle">			<span id="boxName">显示框</span>			<span id="boxClose" title="关闭" onclick="box.Close();">×		</span></div>		<div id="boxContent">			<iframe id="showiframe" src="./home_files/saved_resource.html" frameborder="0" style="width:100%;"></iframe>		</div>	</div></div>
...
<link rel="stylesheet" type="text/css" href="./home_files/box.css">
<link rel="stylesheet" type="text/css" href="./home_files/02549728.css">
<script>
...
<script type="text/javascript" src="./home_files/transform.js"></script>
...
<span style="font-size:72px;"><b><span style="color:#ffffff;font-family:&quot;Microsoft YaHei&quot;;"><?php echo $domain?></span></b></span> </div><div class="diyStyle">
