var AW_TEMPLATE = {
	...
	'imagevideoBox' : 
			'<div id="icb-image-box" class="modal fade icb-alert-box icb-image-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'+
				...
				'<div class="modal-content">'+
					...
					'<div class="modal-body">'+
						...
						'<div class="icb-question-drodpwon">'+
							...
							'<div class="icb-dropdown"><i class="icb-icon i-dropdown-triangle active"></i><p class="title">' + _t('没有找到相关结果') + '</p><ul class="icb-dropdown-list"></ul></div>'+
						'</div>'+
						...
						'<div class="modal-body">'+
							...
							'<form action="' + G_BASE_URL + '/inbox/ajax/send/" method="post" id="quick_publish" onsubmit="return false">'+
								...
								'<div class="icb-dropdown">'+
									'<i class="icb-icon i-dropdown-triangle"></i>'+
	...
	'searchDropdownListTopics' : 
		'<li class="topic clearfix"><a href="{{url}}" class="icb-topic-name" data-id="{{topic_id}}"><span>{{name}}</span></a> <span class="pull-right text-color-999">{{discuss_count}} ' + _t('个讨论') + '</span></li>',
	...
	'questionDropdownList' : 
		'<li class="question" data-id="{{id}}"><a class="icb-hide-txt" target="_blank" _href="{{url}}">{{name}}</a></li>',
	...
	'linkBox' : 
			'<div id="icb-link-box" class="modal icb-alert-box icb-link-box fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'+
	...
	// 后台分类移动设置
	'adminCategoryMove' :
		'<div class="modal fade icb-alert-box icb-category-move-box">'+
			'<div class="modal-dialog">'+
	...
	// 后台微信群发消息弹窗
	'adminWechatSendMsg' :
		'<div class="modal fade icb-alert-box icb-wechat-send-message">'+
			'<div class="modal-dialog">'+
				'<form method="post" id="settings_form" action="' + G_BASE_URL + '/admin/ajax/move_category_contents/">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
						...
						'</div>'+
						'<div class="modal-body">'+
							'<div class="icb-dropdown-box">'+
								'<div class="alert alert-danger collapse error_message"></div>'+
								'<input type="text" class="form-control search-input" />'+
								'<div class="icb-dropdown"><p class="title">' + _t('没有找到相关结果') + '</p><ul class="icb-dropdown-list"><li><a>123</a></li></ul></div>'+
							'</div>'+
						'</div>'+
						'<div class="modal-footer">'+
							'<a class="btn btn-default" aria-hidden="true" data-dismiss="modal">' + _t('取消') + '</a>'+
